...
fromInitialSum :: (Ord a, Num a) => [(Skein, a)] -> ChordDiagramsSum a
fromInitialSum =
...
glueHandle :: (SkeinRelation r a) => r -> Int -> ChordDiagramsSum a -> (UArray Int Int, ChordDiagramsSum a)
...
connect :: (SkeinRelation r a) => r -> (Int, ChordDiagramsSum a) -> (Int, ChordDiagramsSum a) -> (UArray Int Int, UArray Int Int, ChordDiagramsSum a)
...
assembleStateSum :: (SkeinRelation r a) => r -> Array Int (Int, Int) -> Array Int (Array Int Int) -> Array Int (ChordDiagramsSum a) -> a -> ChordDiagramsSum a
