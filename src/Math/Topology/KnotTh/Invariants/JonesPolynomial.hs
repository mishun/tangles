...
instance KnottedWithJonesPolynomial Tangle where
    ...
    minimalJonesPolynomial = skeinRelationPostMinimization jonesPolynomial


instance KnottedWithJonesPolynomial Link where
    type JonesPolynomial Link = Poly
    jonesPolynomial = takeAsScalar . jonesPolynomial . linkToTangle
    minimalJonesPolynomial = takeAsScalar . minimalJonesPolynomial . linkToTangle
