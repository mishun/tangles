{-# LANGUAGE Rank2Types #-}
module Math.Topology.KnotTh.Invariants.Skein.SkeinM
    ( module Math.Topology.KnotTh.Invariants.Skein.Relation
    , SkeinM
    , Vertex
    , StrategyResult(..)
    , vertexDegree
...
import Math.Topology.KnotTh.Invariants.Skein.SkeinM.Reduction
