module Math.Topology.KnotTh.Link.Table.Access
    ( numberOfLinks
    , link
    , numberOfKnots
    , knot
...
import Math.Topology.KnotTh.Link.Table.List
...
table :: M.Map (Int, Int, Int) LinkDiagram
table = M.fromList $ do
