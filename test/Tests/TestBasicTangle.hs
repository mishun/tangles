...
tests = "Basic tangle tests" ~:
	...
	, "Show implode 1" ~:
		...
		in show t ~?= "(Tangle (0 O) (Border [ (Dart 1 0) (Dart 1 1) (Dart 1 2) (Dart 1 3) ]) (Crossing 1 (I +) [ (Leg 0) (Leg 1) (Leg 2) (Leg 3) ]))"

	, "Show glue 1" ~:
		let t = crossingTangle $ glueToBorder (nthLeg lonerProjection 0) 1 projectionCrossing
		in show t ~?= "(Tangle (0 O) (Border [ (Dart 2 1) (Dart 2 2) (Dart 2 3) (Dart 1 1) (Dart 1 2) (Dart 1 3) ]) (Crossing 1 (I +) [ (Dart 2 0) (Leg 3) (Leg 4) (Leg 5) ]) (Crossing 2 (I +) [ (Dart 1 0) (Leg 0) (Leg 1) (Leg 2) ]))"

	, "Show glue 2" ~:
		let t = crossingTangle $ glueToBorder (nthLeg lonerProjection 1) 2 projectionCrossing
		in show t ~?= "(Tangle (0 O) (Border [ (Dart 2 2) (Dart 2 3) (Dart 1 2) (Dart 1 3) ]) (Crossing 1 (I +) [ (Dart 2 1) (Dart 2 0) (Leg 2) (Leg 3) ]) (Crossing 2 (I +) [ (Dart 1 1) (Dart 1 0) (Leg 0) (Leg 1) ]))"

	, "Show glue 3" ~:
		let t = crossingTangle $ glueToBorder (nthLeg lonerProjection 3) 3 projectionCrossing
		in show t ~?= "(Tangle (0 O) (Border [ (Dart 2 3) (Dart 1 0) ]) (Crossing 1 (I +) [ (Leg 1) (Dart 2 2) (Dart 2 1) (Dart 2 0) ]) (Crossing 2 (I +) [ (Dart 1 3) (Dart 1 2) (Dart 1 1) (Leg 0) ]))"
	]
